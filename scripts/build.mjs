...
function newFilm(lang,id,title,showCaption=true){return `<article class="paper-film"><div class="film-media" data-film><video class="ambient-video" muted playsinline loop preload="none" poster="/assets/images/video-posters/june-${id}.jpg" width="576" height="1024" aria-label="${esc(title)}"><source src="/assets/videos/room-june-${id}.mp4" type="video/mp4"></video><a class="film-error" href="/assets/videos/room-june-${id}.mp4" target="_blank" rel="noopener" hidden>${design[lang].filmFallback}</a></div>${showCaption?`<h4>${title}</h4>`:''}</article>`;}
