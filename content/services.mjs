export const serviceSlugs={party:'bernu-ballites',workshops:'telpas-nodarbibam'};
export const servicePages={
 lv:{
  party:{
   name:'Bērnu ballītes',title:'Telpa bērnu ballītēm Jūrmalā | ROOM Jūrmala',description:'Telpa bērnu dzimšanas dienām un ģimenes svinībām Kauguros, Jūrmalā. Rotaļu zona, virtuvīte, noma no 20 € stundā. Izvēlieties datumu un sazinieties WhatsApp.',
   heading:'Mazie svētki.<br><em>Lielie prieki.</em>',eyebrow:'Telpa bērnu ballītēm Jūrmalā',intro:'Aiciniet ģimeni un draugus uz bērna dzimšanas dienu. Pie mums ir vieta rotaļām, svētku galdam un kūkai.',
   image:4,detailImage:2,video:0,poster:'celebrate',caption:'Ģimenes un draugu svinības ROOM Jūrmala.',
   detailTitle:'Svinības pēc<br><em>jūsu ieceres.</em>',details:[['Vieta bērnu rotaļām','Bērni var spēlēties rotaļu zonā un darboties uz mīkstā paklāja. Galdus un krēslus izvietosim tā, lai pietiktu vietas arī plānotajām spēlēm.'],['Kūkai un uzkodām','Cienastu var ērti sagatavot un pasniegt virtuvītē. Pirms svētkiem sarunāsim, ko nesīsiet līdzi un cik laika vajadzēs telpas dekorēšanai.'],['Ērti atbraukt','Atrodamies Skolas ielā 50, Kauguros. Auto var bez maksas novietot pie ēkas.']],
   priceTitle:'Laiks jūsu<br><em>svinībām.</em>',rates:[['20 €','1 stunda'],['55 €','3 stundas'],['130 €','8 stundas']],priceNote:'Ja svētkiem vajadzīgs kas īpašs, pastāstiet mums par to, piesakot datumu.',
   faq:[['Vai var rīkot bērna dzimšanas dienu?','Jā. ROOM Jūrmala var izmantot bērnu dzimšanas dienām un ģimenes svinībām. Sazinoties norādiet bērnu vecumu un viesu skaitu, lai pārrunātu piemērotāko iekārtojumu.'],['Cik viesu var piedalīties?','Piemērotais viesu skaits ir atkarīgs no galdu izvietojuma, bērnu vecuma un plānotajām aktivitātēm. Pirms rezervācijas saskaņosim jūsu grupai piemērotu formātu.'],['Vai telpas nomā ir iekļauts ballītes vadītājs?','Šajā lapā norādīta telpas noma. Ja vajadzīgs ballītes vadītājs vai cita programma, pārrunājiet to atsevišķi pirms rezervācijas.'],['Kā pieteikt savu datumu?','Kalendārā izvēlieties datumu, norādiet aptuveno sākuma laiku un atveriet sagatavoto WhatsApp ziņu. Pieejamību un rezervāciju apstiprināsim sarakstē.']],
   related:'Vajadzīga telpa meistarklasei?',request:'Bērnu ballīte vai ģimenes svinības'
  },
  workshops:{
   name:'Nodarbības un meistarklases',title:'Telpu noma nodarbībām Jūrmalā | ROOM Jūrmala',description:'Telpu noma meistarklasēm, jogai, vingrošanai un bērnu nodarbībām Jūrmalā. Galdi, krēsli, virtuvīte un iespēja regulārai nomai. No 20 € stundā.',
   heading:'Vieta jūsu<br><em>zināšanām.</em>',eyebrow:'Nodarbībām un meistarklasēm',intro:'Meklējat vietu savai nodarbībai? Šeit var vadīt meistarklasi, jogu, vingrošanu vai nelielu semināru. Telpu var rezervēt gan vienai reizei, gan regulārām nodarbībām.',
   image:0,detailImage:3,video:3,poster:'create',caption:'Radošā darbnīca bērniem ROOM Jūrmala.',
   detailTitle:'No kopīga galda<br><em>līdz kustībai.</em>',details:[['Zīmēšanai un rokdarbiem','Pie galdiem var zīmēt, darināt rokdarbus un darboties kopā. Nodarbību plāno pasniedzējs. Par materiāliem un galdu izvietojumu vienosimies iepriekš.'],['Jogai un vingrošanai','Telpā var atbrīvot vietu jogas paklājiem, vingrošanai un bērnu kustību nodarbībām. Pasakiet, cik cilvēku būs grupā un kāds inventārs vajadzīgs.'],['Savai grupai katru nedēļu','Ja nodarbības vadāt regulāri, varam vienoties par noteiktām nedēļas dienām un laikiem. Pieejama gan stundas noma, gan abonements.']],
   priceTitle:'Viena nodarbība.<br><em>Vai savs ritms.</em>',rates:[['20 €','1 stunda'],['130 €','8 stundas'],['460 €','mēnesī · 8 h nedēļā']],priceNote:'Abonementa minimālais termiņš ir 3 mēneši. Brīvos laikus sarunāsim pirms rezervēšanas.',
   faq:[['Vai var nomāt telpu regulārām nodarbībām?','Jā. Abonements maksā 460 € mēnesī un ietver 8 stundas nedēļā, ar vismaz 3 mēnešu termiņu. Konkrētās dienas un laikus saskaņojam individuāli.'],['Kāds aprīkojums ir telpā?','Pieejami galdi, krēsli, virtuvīte un zona aktivitātēm. Par sporta inventāru, darbnīcas materiāliem un īpašām tehniskām vajadzībām vienojieties pirms nodarbības.'],['Vai kalendārā var pieteikties jau esošai nodarbībai?','Jā. Izvēlieties atzīmēto datumu un spiediet pieteikšanās pogu pie nodarbības. WhatsApp ziņā būs tās nosaukums, datums un sākuma laiks. Dalību apstiprināsim sarakstē.'],['Vai nomas cena ietver pasniedzēja darbu?','Nē. Norādītās cenas attiecas uz telpas nomu. Dalība kalendārā redzamā nodarbībā ir atsevišķs pieteikums; tās cenu un norisi precizējiet sarakstē.']],
   related:'Plānojat bērna dzimšanas dienu?',request:'Telpas noma nodarbībai vai meistarklasei'
  }
 },
 en:{
  "party": {
