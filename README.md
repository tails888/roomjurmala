...
4. Privately give each person only their own URL from `activation-links.json`. Each person opens it and chooses a password of at least 12 characters. Their email is prefilled. This version does not send email. Afterwards both use `https://roomjurmala.lv/admin/`.
