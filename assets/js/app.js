...
if(siteStyles&&siteStyles.media!=='all')await new Promise(resolve=>{siteStyles.addEventListener('load',resolve,{once:true});siteStyles.addEventListener('error',resolve,{once:true});});
